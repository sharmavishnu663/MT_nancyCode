...
function WhyMtEducare() {
  return (
    <>
      <section className="why-mt-educare">
        <div className="container">
          <div className="row">
            <div className="col-md-12">
              <h3 className="text-center">
                Why <span className="text-orange">MT Educare</span>
              </h3>
              <p className="text-center">Because we are a growth-driven platform and upskill our students to achieve something big and great.</p>
            </div>
          </div>
